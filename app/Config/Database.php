...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Load runtime DB config from environment.
        // NOTE: This must happen in the constructor because PHP does not allow
        // function calls (like env()) inside property initializers.
